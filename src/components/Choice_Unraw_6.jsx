...
export default function Add_wideth_Raw() {
  ...
  const w_name = [
    "Unraw3_criteriaR2#R7",
    "Unraw3_criteriaR3#R4",
    "Unraw3_criteriaR3#R5",
    "Unraw3_criteriaR3#R6",
    "Unraw3_criteriaR3#R7",
    "Unraw3_criteriaR4#R5",
    "Unraw3_criteriaR4#R6",
    "Unraw3_criteriaR4#R7",
    "Unraw3_criteriaR5#R6",
    "Unraw3_criteriaR5#R7",
    "Unraw3_criteriaR6#R7",
  ];
  const balck_page = () => {
  ...
  const handleSubmit_2 = () => {
    ...
    if ((testVal1.length, testVal2.length, testVal3.length === 0)) {
      ...
      window.location = "/Choice_UnRaw_7";
      ...
      <AppBar position="relative">
        <Toolbar>
          <Typography variant="h6" color="inherit" noWrap>
            โปรดเลือกระดับความสําคัญการขนส่งวัตถุดิบ (1.3) 6/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
