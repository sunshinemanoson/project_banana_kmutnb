...
export default function Add_wideth_Raw() {
  ...
  // console.log("2",Math.abs(val_2_7));
  // console.log("3",Math.abs(val_3_2));
  // console.log("4",Math.abs(val_3_6));
  // console.log("5",Math.abs(val_3_9));
  // console.log("6",Math.abs(val_3_11));
  // console.log("7",Math.abs(val_3_12));
  ...
  const w_name = [
    "Unraw1_criteriaR2#R7",
    "Unraw1_criteriaR3#R4",
    "Unraw1_criteriaR3#R5",
    "Unraw1_criteriaR3#R6",
    "Unraw1_criteriaR3#R7",
    "Unraw1_criteriaR4#R5",
    "Unraw1_criteriaR4#R6",
    "Unraw1_criteriaR4#R7",
    "Unraw1_criteriaR5#R6",
    "Unraw1_criteriaR5#R7",
    "Unraw1_criteriaR6#R7",
  ];
  const balck_page = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.log("resdataCal", Result1.toFixed(3), Result2.toFixed(3), Result3.toFixed(3),Result4.toFixed(3),Result5.toFixed(3),Result6.toFixed(3),Result7.toFixed(3));
  ...
  const handleSubmit_2 = () => {
    ...
    if ((testVal1.length, testVal2.length, testVal3.length === 0)) {
      ...
      window.location = "/Choice_UnRaw_3";
      ...
      <AppBar position="relative">
        <Toolbar>
          <Typography variant="h6" color="inherit" noWrap>
            โปรดเลือกระดับความสําคัญความสุกของวัตถุดิบ (1.1) 2/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
