...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw15_criteriaR1#R2",
  "Unraw15_criteriaR1#R3",
  "Unraw15_criteriaR1#R4",
  "Unraw15_criteriaR1#R5",
  "Unraw15_criteriaR1#R6",
  "Unraw15_criteriaR1#R7",
  "Unraw15_criteriaR2#R3",
  "Unraw15_criteriaR2#R4",
  "Unraw15_criteriaR2#R5",
  "Unraw15_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_30";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญมีนโยบายส่งเสริมจากรัฐบาล (5.1) 29/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
