...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw7_criteriaR1#R2",
  "Unraw7_criteriaR1#R3",
  "Unraw7_criteriaR1#R4",
  "Unraw7_criteriaR1#R5",
  "Unraw7_criteriaR1#R6",
  "Unraw7_criteriaR1#R7",
  "Unraw7_criteriaR2#R3",
  "Unraw7_criteriaR2#R4",
  "Unraw7_criteriaR2#R5",
  "Unraw7_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_14";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญความพร้อมของอุปกรณ์ในการผลิต (2.4) 13/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
