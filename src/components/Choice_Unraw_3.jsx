...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw2_criteriaR1#R2",
  "Unraw2_criteriaR1#R3",
  "Unraw2_criteriaR1#R4",
  "Unraw2_criteriaR1#R5",
  "Unraw2_criteriaR1#R6",
  "Unraw2_criteriaR1#R7",
  "Unraw2_criteriaR2#R3",
  "Unraw2_criteriaR2#R4",
  "Unraw2_criteriaR2#R5",
  "Unraw2_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_4";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญปริมาณกล้วยที่เพียงพอ (1.2)  3/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
