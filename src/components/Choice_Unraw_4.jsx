...
export default function Add_wideth_Raw() {
  ...
  const w_name = [
    "Unraw2_criteriaR2#R7",
    "Unraw2_criteriaR3#R4",
    "Unraw2_criteriaR3#R5",
    "Unraw2_criteriaR3#R6",
    "Unraw2_criteriaR3#R7",
    "Unraw2_criteriaR4#R5",
    "Unraw2_criteriaR4#R6",
    "Unraw2_criteriaR4#R7",
    "Unraw2_criteriaR5#R6",
    "Unraw2_criteriaR5#R7",
    "Unraw2_criteriaR6#R7",
  ];
  const balck_page = () => {
  ...
  const handleSubmit_2 = () => {
    ...
    if ((testVal1.length, testVal2.length, testVal3.length === 0)) {
      ...
      window.location = "/Choice_UnRaw_5";
      ...
      <AppBar position="relative">
        <Toolbar>
          <Typography variant="h6" color="inherit" noWrap>
            โปรดเลือกระดับความสําคัญปริมาณกล้วยที่เพียงพอ (1.2) 4/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
