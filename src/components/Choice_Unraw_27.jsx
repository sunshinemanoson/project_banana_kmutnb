...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw14_criteriaR1#R2",
  "Unraw14_criteriaR1#R3",
  "Unraw14_criteriaR1#R4",
  "Unraw14_criteriaR1#R5",
  "Unraw14_criteriaR1#R6",
  "Unraw14_criteriaR1#R7",
  "Unraw14_criteriaR2#R3",
  "Unraw14_criteriaR2#R4",
  "Unraw14_criteriaR2#R5",
  "Unraw14_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_28";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญสถานที่และขนาดพื้นที่ในการเก็บรักษา (4.3) 27/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
