...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw12_criteriaR1#R2",
  "Unraw12_criteriaR1#R3",
  "Unraw12_criteriaR1#R4",
  "Unraw12_criteriaR1#R5",
  "Unraw12_criteriaR1#R6",
  "Unraw12_criteriaR1#R7",
  "Unraw12_criteriaR2#R3",
  "Unraw12_criteriaR2#R4",
  "Unraw12_criteriaR2#R5",
  "Unraw12_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_24";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญสามารถเก็บได้ที่อุณหภูมิปกติ (4.1) 23/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
