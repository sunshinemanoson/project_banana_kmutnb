...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw3_criteriaR1#R2",
  "Unraw3_criteriaR1#R3",
  "Unraw3_criteriaR1#R4",
  "Unraw3_criteriaR1#R5",
  "Unraw3_criteriaR1#R6",
  "Unraw3_criteriaR1#R7",
  "Unraw3_criteriaR2#R3",
  "Unraw3_criteriaR2#R4",
  "Unraw3_criteriaR2#R5",
  "Unraw3_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_6";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญการขนส่งวัตถุดิบ (1.3)  5/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
