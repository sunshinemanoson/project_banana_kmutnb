...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw16_criteriaR1#R2",
  "Unraw16_criteriaR1#R3",
  "Unraw16_criteriaR1#R4",
  "Unraw16_criteriaR1#R5",
  "Unraw16_criteriaR1#R6",
  "Unraw16_criteriaR1#R7",
  "Unraw16_criteriaR2#R3",
  "Unraw16_criteriaR2#R4",
  "Unraw16_criteriaR2#R5",
  "Unraw16_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_32";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญผลกระทบจากการแปรรูปที่มีต่อสิ่งแวดล้อม (5.2) 31/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
