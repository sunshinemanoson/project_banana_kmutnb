...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw17_criteriaR1#R2",
  "Unraw17_criteriaR1#R3",
  "Unraw17_criteriaR1#R4",
  "Unraw17_criteriaR1#R5",
  "Unraw17_criteriaR1#R6",
  "Unraw17_criteriaR1#R7",
  "Unraw17_criteriaR2#R3",
  "Unraw17_criteriaR2#R4",
  "Unraw17_criteriaR2#R5",
  "Unraw17_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_34";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญการสร้างรายได้ให้กับชุมชน (5.3) 33/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
