...
export default function Add_wideth_Raw() {
  ...
  // console.log("test",val_4_2 + val_4_3 + val_4_4 + val_4_5 + val_4_6 + val_4_7)

  if (testVal1 < 0) {
    let val_Po_4_2;
    val_4_2 = val_Po_4_2 = re / testVal1;
    Math.abs(val_4_2);
    var val_re4_2 = re / Math.abs(val_4_2);
    console.log("val2", Math.abs(val_4_2));
    console.log("re2", Math.abs(val_re4_2));
  ...
  const add_subgroup = [4,5,6,7,8,9];
  ...
  const w_name = [
    "sub2_criteria2.1#2.2",
    "sub2_criteria2.1#2.3",
    "sub2_criteria2.1#2.4",
    "sub2_criteria2.2#2.3",
    "sub2_criteria2.2#2.4",
    "sub2_criteria2.3#2.4",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    if (
      ...
      window.location = "/Add_wideth_Raw_5";
