...
export default function Add_wideth_Raw() {
  ...
  const w_name = [
    "Unraw6_criteriaR2#R7",
    "Unraw6_criteriaR3#R4",
    "Unraw6_criteriaR3#R5",
    "Unraw6_criteriaR3#R6",
    "Unraw6_criteriaR3#R7",
    "Unraw6_criteriaR4#R5",
    "Unraw6_criteriaR4#R6",
    "Unraw6_criteriaR4#R7",
    "Unraw6_criteriaR5#R6",
    "Unraw6_criteriaR5#R7",
    "Unraw6_criteriaR6#R7",
  ];
  const balck_page = () => {
      ...
      <AppBar position="relative">
        <Toolbar>
          <Typography variant="h6" color="inherit" noWrap>
            โปรดเลือกระดับความสําคัญความสนใจของเจ้าของกิจการ (2.3) 12/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
