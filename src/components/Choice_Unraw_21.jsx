...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw11_criteriaR1#R2",
  "Unraw11_criteriaR1#R3",
  "Unraw11_criteriaR1#R4",
  "Unraw11_criteriaR1#R5",
  "Unraw11_criteriaR1#R6",
  "Unraw11_criteriaR1#R7",
  "Unraw11_criteriaR2#R3",
  "Unraw11_criteriaR2#R4",
  "Unraw11_criteriaR2#R5",
  "Unraw11_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_22";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญแนวโน้มการส่งออก (3.4) 21/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
