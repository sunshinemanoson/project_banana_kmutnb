...
export default function Add_wideth_Raw() {
  ...
  const w_name = [
    "Unraw16_criteriaR2#R7",
    "Unraw16_criteriaR3#R4",
    "Unraw16_criteriaR3#R5",
    "Unraw16_criteriaR3#R6",
    "Unraw16_criteriaR3#R7",
    "Unraw16_criteriaR4#R5",
    "Unraw16_criteriaR4#R6",
    "Unraw16_criteriaR4#R7",
    "Unraw16_criteriaR5#R6",
    "Unraw16_criteriaR5#R7",
    "Unraw16_criteriaR6#R7",
  ];
  const balck_page = () => {
  ...
  const handleSubmit_2 = () => {
    ...
    if ((testVal1.length, testVal2.length, testVal3.length === 0)) {
      ...
      window.location = "/Choice_UnRaw_33";
      ...
      <AppBar position="relative">
        <Toolbar>
          <Typography variant="h6" color="inherit" noWrap>
            โปรดเลือกระดับความสําคัญผลกระทบจากการแปรรูปที่มีต่อสิ่งแวดล้อม (5.2) 32/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
