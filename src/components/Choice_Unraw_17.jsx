...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw9_criteriaR1#R2",
  "Unraw9_criteriaR1#R3",
  "Unraw9_criteriaR1#R4",
  "Unraw9_criteriaR1#R5",
  "Unraw9_criteriaR1#R6",
  "Unraw9_criteriaR1#R7",
  "Unraw9_criteriaR2#R3",
  "Unraw9_criteriaR2#R4",
  "Unraw9_criteriaR2#R5",
  "Unraw9_criteriaR2#R6",
  ];
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญต้นทุน (3.2) 17/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
