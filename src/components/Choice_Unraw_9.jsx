...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw5_criteriaR1#R2",
  "Unraw5_criteriaR1#R3",
  "Unraw5_criteriaR1#R4",
  "Unraw5_criteriaR1#R5",
  "Unraw5_criteriaR1#R6",
  "Unraw5_criteriaR1#R7",
  "Unraw5_criteriaR2#R3",
  "Unraw5_criteriaR2#R4",
  "Unraw5_criteriaR2#R5",
  "Unraw5_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_10";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญความสามารถของแรงงาน (2.2)  9/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
