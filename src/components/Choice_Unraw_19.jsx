...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw10_criteriaR1#R2",
  "Unraw10_criteriaR1#R3",
  "Unraw10_criteriaR1#R4",
  "Unraw10_criteriaR1#R5",
  "Unraw10_criteriaR1#R6",
  "Unraw10_criteriaR1#R7",
  "Unraw10_criteriaR2#R3",
  "Unraw10_criteriaR2#R4",
  "Unraw10_criteriaR2#R5",
  "Unraw10_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_20";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญความต้องการของตลาด (3.3) 19/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
