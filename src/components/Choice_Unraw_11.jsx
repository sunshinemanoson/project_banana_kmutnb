...
export default function Add_wideth_Raw() {
  ...
  const w_name = [ 
  "Unraw6_criteriaR1#R2",
  "Unraw6_criteriaR1#R3",
  "Unraw6_criteriaR1#R4",
  "Unraw6_criteriaR1#R5",
  "Unraw6_criteriaR1#R6",
  "Unraw6_criteriaR1#R7",
  "Unraw6_criteriaR2#R3",
  "Unraw6_criteriaR2#R4",
  "Unraw6_criteriaR2#R5",
  "Unraw6_criteriaR2#R6",
  ];
  ...
  const handleSubmit_2 = () => {
    ...
    //   // console.log(add_weight.length)
      ...
      window.location = "/Choice_UnRaw_12";
    ...
    <ThemeProvider theme={theme}>
      ...
      <AppBar position="relative">
        <Toolbar>
          ...
          โปรดเลือกระดับความสําคัญความสนใจของเจ้าของกิจการ (2.3)  11/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
