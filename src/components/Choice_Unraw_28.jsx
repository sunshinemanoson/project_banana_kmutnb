...
export default function Add_wideth_Raw() {
  ...
  const w_name = [
    "Unraw14_criteriaR2#R7",
    "Unraw14_criteriaR3#R4",
    "Unraw14_criteriaR3#R5",
    "Unraw14_criteriaR3#R6",
    "Unraw14_criteriaR3#R7",
    "Unraw14_criteriaR4#R5",
    "Unraw14_criteriaR4#R6",
    "Unraw14_criteriaR4#R7",
    "Unraw14_criteriaR5#R6",
    "Unraw14_criteriaR5#R7",
    "Unraw14_criteriaR6#R7",
  ];
  const balck_page = () => {
  ...
  const handleSubmit_2 = () => {
    ...
    if ((testVal1.length, testVal2.length, testVal3.length === 0)) {
      ...
      window.location = "/Choice_UnRaw_29";
      ...
      <AppBar position="relative">
        <Toolbar>
          <Typography variant="h6" color="inherit" noWrap>
            โปรดเลือกระดับความสําคัญสถานที่และขนาดพื้นที่ในการเก็บรักษา (4.3) 28/34
          </Typography>
        </Toolbar>
      </AppBar>
      <main>
